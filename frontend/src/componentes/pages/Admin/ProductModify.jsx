...
const ProductModify = ({onclose,initialData,modifyeffect}) => {
  ...
  return (
    <div className=' flex items-center justify-center z-[30] top-0 left-0 bottom-0  right-0 z-12 fixed opacity-95 bg-slate-200'>
