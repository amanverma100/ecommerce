...
const Products = () => {
  ...
  return (
    <>
    <div className='flex h-12 px-4 py-1 bg-red-500 justify-between text-black  sticky top-0 left-0 shadow-lg'>
    <div className='text-white text-3xl'>Product show here</div>
